...
from IfEditor import InterfaceEditor

class EtherCAT(CodeFile):
    XSD = """<?xml version="1.0" encoding="ISO-8859-1" ?>
    <xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema">
      <xsd:element name="EtherCAText">
        <xsd:complexType>
    ...
    SECTIONS_NAMES = [
        ...
        "retrieveFunction",
        "publishFunction"]
    EditorType = InterfaceEditor
    
    def GetIconName(self):
        return "ecat"

    def CodeFileName(self):
        return os.path.join(self.CTNPath(), "EtherCAT.xml")
